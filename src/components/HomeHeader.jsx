    ...
    <div className="flex flex-col gap-1.5 w-[calc(100vw-16px)] sm:w-full sm:max-w-[680px] bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl rounded-2xl border border-slate-200/60 dark:border-slate-800/80 shadow-[0_8px_32px_rgba(15,23,42,0.1)] pointer-events-auto">
      ...
      <div className="flex items-center gap-2 px-2.5 py-2 sm:px-3 sm:py-1.5">
        <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer group">
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-gradient-to-tr from-emerald-500 to-teal-400 p-0.5 shadow-md shadow-emerald-500/20 group-hover:scale-105 transition-transform duration-300">
            <div className="w-full h-full bg-slate-900 rounded-[9px] sm:rounded-[10px] flex items-center justify-center overflow-hidden">
              <img src="/logo.png" alt="Karta-AD" className="w-4 h-4 sm:w-5 sm:h-5 object-contain" />
            </div>
          </div>
        </div>
